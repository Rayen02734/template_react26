                ...
                <Card>
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <h3 className="mt-1 text-xl font-semibold text-text-primary">You are doing well</h3>
                        </div>
                    </div>
                    <p className="mt-5 text-sm leading-7 text-text-secondary">Your latest quiz suggests your strongest area is systems thinking. A gentle review of accessibility details will make your next attempt even stronger.</p>
                </Card>
